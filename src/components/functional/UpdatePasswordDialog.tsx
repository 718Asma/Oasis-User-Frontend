...
export default function UpdatePasswordDialog({ isPasswordOpen, setIsPasswordOpen }: UpdatePasswordDialogProps) {
    ...
    <Dialog open={isPasswordOpen} onOpenChange={setIsPasswordOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" className="w-full justify-between text-left">
          <a style={{ color: "black", textDecoration: "none" }} className="flex items-center gap-2">
